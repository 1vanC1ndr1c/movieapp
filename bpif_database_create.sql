...
insert into hibernate_sequence values ( 1 );
insert into hibernate_sequence values ( 1 );
create table movie (id bigint not null, name varchar(255), movie_description varchar(255), movie_runtime longblob, release_date longblob, primary key (id)) engine=MyISAM;
create table movie_category_list (movie_id bigint not null, category longblob) engine=MyISAM;
